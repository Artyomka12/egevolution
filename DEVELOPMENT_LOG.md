...
**Ветка:** main
**Версия:** v1.7.1
**Статус:** выполнено — визуальная унификация визуализатора Python-кода с остальным сайтом (общий navbar, светлая тема под палитру сайта, инверсия navbar под тёмной темой визуализатора)
