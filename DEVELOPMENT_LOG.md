...
**Ветка:** main
**Версия:** v1.10.0
**Статус:** выполнено — 6 разноплановых доработок платформы за одну сессию: полная пересборка базы вариантов (20 новых сбалансированных вместо 14 старых), сквозная связь статистики попыток с базой заданий, статистика решаемости по каждому из 27 номеров заданий (для себя и в админке), открытие базы заданий и первого урока/темы теории для гостей, обязательное поле «Имя» и подсказка о пароле сайта на регистрации, версия сайта в футере, замена нечитаемых на мобильных эмодзи-замков на эмодзи+текст.
