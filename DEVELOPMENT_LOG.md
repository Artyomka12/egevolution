...
**Ветка:** main
**Версия:** v1.8.3
**Статус:** выполнено — наполнение базы задач реальным контентом с kompege.ru для заданий 19–25 (763 новые задачи суммарно), архитектура «связанной тройки» для заданий 19–21, расширенный пул задания 22, урезанный по объёму файлов пул задания 24, табличный формат ответа `answer_grid` для задания 25; плюс критический фикс коллизии плейсхолдеров в `replace_markers()`
