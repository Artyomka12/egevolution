...
**Ветка:** main
**Версия:** v1.8.1
**Статус:** выполнено — наполнение базы задач реальным контентом с kompege.ru для заданий 4–10 (780 задач суммарно), включая приложенные файлы и три класса точечных исправлений парсера контента
