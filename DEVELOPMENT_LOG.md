...
**Ветка:** main
**Версия:** v1.8.0
**Статус:** выполнено — наполнение базы задач реальным контентом с kompege.ru для заданий 1–3 (317 задач суммарно), включая рендеринг таблиц истинности и загрузку файлов баз данных
