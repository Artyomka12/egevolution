...
**Ветка:** main
**Версия:** v1.8.2
**Статус:** выполнено — наполнение базы задач реальным контентом с kompege.ru для заданий 11–18 (851 задача суммарно), новый рендерер таблиц МТ, конвертер LaTeX, двухчастный формат ответа; плюс сплошной аудит и исправление точечных багов в заданиях 1–18
