...
**Ветка:** main
**Версия:** v1.7.2
**Статус:** выполнено — Block Scheme визуализатора строит диаграммы пользовательских функций с анимацией вызова/возврата (в т.ч. рекурсия), блок-витрина визуализатора на главной странице, исправлены наложение диаграмм и источник шарика Memory/Output, донастроены отступы/ширина области
