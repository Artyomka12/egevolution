...
**Ветка:** main
**Версия:** v1.7.0
**Статус:** выполнено — интеграция визуализатора Python-кода (отдельный проект visual-code, встроен как модуль в app.py, доступ только для авторизованных, кнопка в navbar и на start.html)
