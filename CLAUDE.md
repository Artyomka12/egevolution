...
**Текущая версия: v1.8.1** — база задач наполнена реальным контентом с
kompege.ru для Заданий №4–10 (780 задач: 122 + 125 + 78 + 122 + 127 + 91 + 115),
включая приложенные файлы (аудио-описания, таблицы, документы) и точечные
исправления парсера (`<div>`/`<pre>`/`<ol>`/`<li>` внутри условия, сбалансированное
разбиение `<b>`/`<i>` по `<br/>`). Заодно ретроактивно убраны авторские подписи
из Заданий №1–4 и убрано скругление углов у картинок-таблиц. Код проекта не
