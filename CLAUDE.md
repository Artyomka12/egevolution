...
**Текущая версия: v1.8.3** — база задач наполнена реальным контентом с
kompege.ru для Заданий №19–25 (763 новые задачи: 113 + 113 + 113 + 110 + 119
+ 75 + 120). Задания 19–21 образуют на реальном экзамене «связанную тройку»
