...
**Текущая версия: v1.8.2** — база задач наполнена реальным контентом с
kompege.ru для Заданий №11–18 (851 задача: 120 + 60 + 100 + 128 + 130 + 118 +
85 + 110), включая новый рендерер таблиц-программ для Машины Тьюринга
(Задание 12), конвертер LaTeX-формул в юникод (`\lor`, `\cdot`, `\times`,
`X^{Y}` и др. — Задания 14–16), двухчастный формат ответа `answers: [a, b]`
(Задания 17–18) и приоритетную загрузку файлов. По итогам сплошного аудита
всех 2029 задач Заданий №1–18 исправлены точечные баги парсера прошлых
версий (необработанный LaTeX в Заданиях 13/14, пропущенная авторская подпись
в Задании 8, дубль в Задании 2, пустые теги-обёртки с пробелом по всей базе).
Код проекта не менялся — только содержимое `tasks/task_11/`…`tasks/task_18/`
и ретроактивные правки `tasks/task_02/`, `tasks/task_08/`, `tasks/task_13/`,
`tasks/task_14/`.
