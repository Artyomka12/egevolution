...
**Текущая версия: v1.8.0** — база задач наполнена реальным контентом с
kompege.ru для Заданий №1–3 (317 задач: 113 + 116 + 88), включая рендеринг
таблиц истинности в картинки и загрузку файлов баз данных. Код проекта не
менялся — только содержимое `tasks/task_01/`, `tasks/task_02/`, `tasks/task_03/`.
